...
@media (prefers-color-scheme: dark) {
    ...
    article { color: rgba(255, 255, 255, .86); }
}
```

### [CSS scroll-behavior和JS scrollIntoView让页面滚动平滑](https://www.zhangxinxu.com/wordpress/2018/10/scroll-behavior-scrollintoview-%e5%b9%b3%e6%bb%9a%e6%bb%9a%e5%8a%a8/)
...
### [杀了个回马枪，还是说说position:stickky吧](https://www.zhangxinxu.com/wordpress/2018/12/css-position-sticky/)
...
蝉原则"与CSS3随机多背景随机圆角等效果](https://w3cplus.com/css3/css-secrets/random-backgrounds.html)
...
### [纯CSS实现视差滚动效果](https://www.zhangxinxu.com/wordpress/2015/03/css-only-parallax-effect/)
...
### [CSS3 webkit下彩条文字效果实现](https://www.zhangxinxu.com/wordpress/2015/03/css3-colorful-text/)

```css
line-height: 20px;
-webkit-background-clip: text;
-webkit-text-fill-color: transparent;
background-image: linear-gradient(to bottom, #9588DD, #9588DD 25%, #DD88C8 25%, #DD88C8 50%);
```
...
> multiply screen overlay darken lighten color-dodge color-burn difference exclusion
...
### [CSS1-CSS3 color颜色知识知多少？](https://www.zhangxinxu.com/wordpress/2015/07/know-css1-css3-color/)
...
### [小tip: 0学习成本实现HTML元素粘滞融合效果](https://www.zhangxinxu.com/wordpress/2017/12/svg-filter-fuse-gooey-effect/)
...
### [伪元素表单控件默认样式重置与自定义大全](https://www.zhangxinxu.com/wordpress/2013/06/%e4%bc%aa%e5%85%83%e7%b4%a0-%e8%a1%a8%e5%8d%95%e6%a0%87%e5%bc%8f-pseudo-elements-style-form-controls/)
...
### [CSS伪类+SVG实现图片任意颜色赋色技术](https://www.zhangxinxu.com/wordpress/2017/06/css-svg-filter-change-color/)

### [使用CSS将图片转换成黑白(灰色、置灰)](https://www.zhangxinxu.com/wordpress/2012/08/css-svg-filter-image-grayscale/)
...
### [CSS :is()或:where()伪类让scoped的style依然全局匹配](https://www.zhangxinxu.com/wordpress/2022/09/css-is-where-scoped-style/)

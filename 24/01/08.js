...
const walk = (pca, parentName, str) => {
    if (Object.prototype.toString.call(pca) === '[object Object]') {
        if (parentName.includes(str)) {
            arr.push(parentName)
        }
        [...Object.entries(pca)].forEach(o => {
            const [key, value] = o
            walk(value, parentName + key, str)
        })
    } else if (Object.prototype.toString.call(pca) === '[object Array]') {
        if (parentName.includes(str)) {
            arr.push(parentName)
        }
        pca.forEach(o => {
            if (o.includes(str)) {
                arr.push(parentName + o)
            }
        })
    }
}
